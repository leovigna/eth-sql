...
library Bytes32DictionaryLib {
    ...
    function containsKey(Bytes32Dictionary storage bytes32Dictionary, bytes32 key)
        internal
        view
        returns (bool)
    {
    ...
    function getKeyAtIndex(Bytes32Dictionary storage bytes32Dictionary, uint256 index)
        internal
        view
        returns (bytes32)
    {
     ...
     */
    function setValueForKey(Bytes32Dictionary storage bytes32Dictionary, bytes32 key, bytes32 value)
        internal
        returns (bool)
    {
    ...
    function getValueForKey(Bytes32Dictionary storage bytes32Dictionary, bytes32 key)
        internal
        view
        returns (bytes32)
    {

...
library BytesSetDictionaryLib {
    ...
    function getKeyAtIndex(BytesSetDictionary storage setDictionary, uint256 index)
        internal
        view
        returns (bytes32)
    {
     ...
     * Returns false if the value was already in the setDictionary.
     */
    function addValueForKey(BytesSetDictionary storage setDictionary, bytes32 key, bytes memory value)
        internal
        returns (bool)
    {
     ...
     */
    function removeValueForKey(BytesSetDictionary storage setDictionary, bytes32 key, bytes memory value)
        internal
        returns (bool)
    {
        if(containsKey(setDictionary, key)) {
     ...
     */
    function containsValueForKey(BytesSetDictionary storage setDictionary, bytes32 key, bytes memory value)
        internal
        view
        returns (bool)
    {
    ...
    function getValueForKey(BytesSetDictionary storage setDictionary, bytes32 key)
        internal
        view
        returns (BytesSetLib.BytesSet storage)
    {
    ...
    function enumerateForKey(BytesSetDictionary storage setDictionary, bytes32 key)
        internal
        view
    ...
    */
    function getValueAtIndexForKey(BytesSetDictionary storage setDictionary, bytes32 key, uint256 index)
        internal
        view
        returns (bytes memory)
    {

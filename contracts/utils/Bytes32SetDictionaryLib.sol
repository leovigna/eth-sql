...
library Bytes32SetDictionaryLib {
    ...
    function containsKey(Bytes32SetDictionary storage setDictionary, bytes32 key)
        internal
        view
        returns (bool)
    {
    ...
    function getKeyAtIndex(Bytes32SetDictionary storage setDictionary, uint256 index)
        internal
        view
        returns (bytes32)
    {
     ...
     * Returns false if the value was already in the setDictionary.
     */
    function addValueForKey(Bytes32SetDictionary storage setDictionary, bytes32 key, bytes32 value)
        internal
        returns (bool)
    {
     ...
     */
    function removeValueForKey(Bytes32SetDictionary storage setDictionary, bytes32 key, bytes32 value)
        internal
        returns (bool)
    {
        if(containsKey(setDictionary, key)) {
     ...
     */
    function containsValueForKey(Bytes32SetDictionary storage setDictionary, bytes32 key, bytes32 value)
        internal
        view
        returns (bool)
    {
    ...
    function getValueForKey(Bytes32SetDictionary storage setDictionary, bytes32 key)
        internal
        view
    ...
    function enumerateForKey(Bytes32SetDictionary storage setDictionary, bytes32 key)
        internal
        view
        returns (bytes32[] memory)
    {
     ...
     * @dev Returns the number of elements on the setDictionary. O(1).
     */
    function lengthForKey(Bytes32SetDictionary storage setDictionary, bytes32 key)
        internal
        view
        returns (uint256)
    {
    ...
    */
    function getValueAtIndexForKey(Bytes32SetDictionary storage setDictionary, bytes32 key, uint256 index)
        internal
        view
        returns (bytes32)
    {

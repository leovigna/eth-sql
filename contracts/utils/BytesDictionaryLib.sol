...
library BytesDictionaryLib {
    ...
    function getKeyAtIndex(BytesDictionary storage bytesDictionary, uint256 index)
        internal
        view
        returns (bytes32)
    {
     ...
     */
    function setValueForKey(BytesDictionary storage bytesDictionary, bytes32 key, bytes memory value)
        internal
        returns (bool)
    {
    ...
    function getValueForKey(BytesDictionary storage bytesDictionary, bytes32 key)
        internal
        view

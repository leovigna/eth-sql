...
library Bytes32SetLibMapping {
     ...
     */
    function addValueForKey(Bytes32SetMapping storage setMapping, bytes32 key, bytes32 value)
        internal
        returns (bool)
    {
     ...
     */
    function removeValueForKey(Bytes32SetMapping storage setMapping, bytes32 key, bytes32 value)
        internal
        returns (bool)
    {
     ...
     */
    function containsValueForKey(Bytes32SetMapping storage setMapping, bytes32 key, bytes32 value)
        internal
        view
        returns (bool)
    {
    ...
    */
    function getValueAtIndexForKey(Bytes32SetMapping storage setMapping, bytes32 key, uint256 index)
        internal
        view
        returns (bytes32)
    {
